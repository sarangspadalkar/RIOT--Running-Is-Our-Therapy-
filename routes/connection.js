...
router.post(
    ...
    [
        check('Topic')
            .custom((value) => {
                if (
                    !value.split(' ').every(function (word) {
                        return validator.isAlphanumeric(word);
                    })
                ) {
                    throw new Error(
                        'Topic field must consists of alphabetical chars.'
                    );
                    return false;
                }
                return true;
            ...
            .not()
            .isEmpty()
            .withMessage('Topic  Value Cannot be left blank'),
        ...
        check('Name')
            .custom((value) => {
                if (
                    ...
                    throw new Error(
                        'Name field must consists of alphabetical chars.'
                    );
                    return false;
                }
                return true;
            ...
            .not()
            .isEmpty()
            .withMessage('Name  Value Cannot be left blank'),
        check('Details')
            .custom((value) => {
                if (
                    !value.split(' ').every(function (word) {
                    ...
                    throw new Error(
                        'Details field must consists of alphabetical chars.'
                    );
                    return false;
                }
                return true;
            ...
            .not()
            .isEmpty()
            .withMessage('Details  Value Cannot be left blank'),
        check('Where')
            .custom((value) => {
                if (
                    !value.split(' ').every(function (word) {
                    ...
                    throw new Error(
                        'Where field must consists of alphabetical chars.'
                    );
                    return false;
                }
                return true;
            ...
            .not()
            .isEmpty()
            .withMessage('Where  Value Cannot be left blank'),
        check('When')
            .custom((value) => {
    ...
    async function (req, res) {
        if (req.session.theUser) {
            ...
            if (!errors.isEmpty()) {
                ...
                var host = String(
                    req.session.theUser.firstName +
                        ' ' +
                        req.session.theUser.lastName
                );
                var connectionId = await userProfileDb.addConnection(
                ...
                var savedConnections =
                    await userProfileDb.getUserConnectionList(
                        req.session.theUser.userId
                    );
